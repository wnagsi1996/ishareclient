<template>
	<div>
		<Header title="Privacy Security Policy" />
		<div class="help-info privacy">
			<h2 class="text-center">PRIVACY STATEMENT / COOKIE STATEMENT</h2>
			        <h3>PRIVACY STATEMENT</h3>
			        <p>This Privacy Statement explains how Love Share Co., Ltd.(collectively, "iSHARE," "we," "us," or "our") collect, use, share and process your information.</p>
			        <h3>Quick Links</h3>
			        ...
			        <ul>
			            ...
			            <li>Data Security, Integrity, and Retention</li>
			            <li>Children</li>
			            <li>Data Transfers, Storage, and Processing Globally</li>
			        ...
			        <p>We use cookies and similar technologies to provide, protect, and improve our products and services, such as by personalizing content, offering and measuring advertisements, understanding user behavior, and providing a safer experience. </p>
			        <p>You can remove or reject cookies using your browser or device settings, but in some cases doing so may affect your ability to use our products and services.</p>
			        <p>Please read our Cookie Statement to learn more about how we use cookies and the choices you have.</p>
			        ...
			        <p>We share personal data with companies that provide services on our behalf, such as website hosting, email services, marketing, sponsoring of sweepstakes, contests, and other promotions, auditing, fulfilling customer orders, data analytics, providing customer service, and conducting customer research and satisfaction surveys. These companies are obligated to protect your data and may be located wherever we operate.</p>
			        <h4>Corporate Affiliates and Corporate Business Transactions</h4>
			        <p>We may share personal data with all Love Share Co., Ltd.-affiliated companies. In the event of a merger, reorganization, acquisition, joint venture, assignment, spin-off, transfer, or sale or disposition of all or any portion of our business, including in connection with any bankruptcy or similar proceedings, we may transfer any and all personal data to the relevant third party. </p>
			        <h4>Legal Compliance and Security</h4>
			        ...
			        <p>We may also disclose personal data if we determine in good faith that disclosure is reasonably necessary to protect our rights and pursue available remedies, enforce our terms and conditions, investigate fraud, or protect our operations or users.</p>
			        <h4>Legal Basis For The Processing of Personal Data from EEA Residents</h4>
			        <p>It may be necessary—by law, legal process, litigation, and/or requests from public and governmental authorities within or outside your country of residence—for us to disclose personal data. We may also disclose personal data if we determine that for purposes of national security, law enforcement, or other issues of public importance, disclosure is necessary or appropriate.</p>
			        ...
			        <p>To protect the privacy and the security of your personal data, we may request data from you to enable us to confirm your identity and right to access such data, as well as to search for and provide you with the personal data we maintain. There are instances where applicable laws or regulatory requirements allow or require us to refuse to provide or delete some or all of the personal data that we maintain.</p>
			        <p>You may Contact Us to exercise your rights. We will respond to your request in a reasonable timeframe, and in any event in less than 30 days.</p>
			        <h3>Closing Accounts</h3>
			        <p>Please contact SHEIN to close your account in relation to the following uses of your personal data:</p>
			        <ul>
			        ...
			        <p>Please contact SHEIN to close your account in relation to the use of your personal data for the provision of products and services you requested.</p>
			        <p>If you close your account, we have no obligation to retain your data, and we may delete any or all of your data without liability. However, we may retain data related to you if we believe it may be necessary to prevent fraud or future abuse, if required by law, or for legitimate purposes, such as analysis of non-personal data, account recovery, auditing our records, and enforcing our rights and obligations under our agreements.</p>
			        ...
			        <h3>Data Security, Integrity, and Retention</h3>
			        <p>We use reasonable technical, administrative, and physical security measures designed to safeguard and help prevent unauthorized access to your data, and to correctly use the data we collect. For example, access to your personal data is restricted to our employees, contractors, and agents who need access to such data to perform their assigned job duties.</p>
			        <p>It is important that you take precautions to protect against unauthorized access to your SHEIN products, account credentials, and computer or other devices. If you feel that the security of your account or personal data has been compromised, please immediately Contact Us. Please be aware that, despite our best efforts, no security system is impenetrable. In the event of a security breach, we will promptly notify you and the proper authorities if required by law. </p>
			        <p>We will retain your personal data for as long as it is necessary to fulfill the purposes outlined in this Privacy Statement, unless a longer retention period is required or permitted by law.</p>
			        <h3>Children</h3>
			        ...
			        <p>Data Transfers, Storage, and Processing Globally</p>
			        <p>When we share your personal data with our partners, SHEIN-affiliated companies, and service providers, your personal data may be transferred to and/or made accessible from countries out of the European Economic Area. In such circumstances, we will enter into model contractual clauses as adopted by the European Commission, or rely on alternative legal bases such as the Privacy Shield, where applicable, or binding corporate rules where our partners or service providers have adopted such internal policies approved by European data protection authorities.</p>
			        <h3>Changes to this Privacy Statement</h3>
			        <p>We may periodically change this Privacy Statement to keep pace with new technologies, industry practices, and regulatory requirements, among other reasons. We expect most such changes to be minor. Any non-material changes will take effect immediately upon posting of an updated Privacy Statement.</p>
			        <p>However, there may be cases where changes to the Privacy Statement may be more significant. In such cases, we will first provide a more prominent notice.</p>
			        <p>Your continued use of the our products and services after the effective date of the Privacy Statement means that you accept the revised Privacy Statement. If you do not agree to the revised Privacy Statement, please refrain from using our products or services and Contact Us to close any account you may have created.</p>
			        <h3>Contact Us</h3>
			        <p>If you have any questions regarding this Privacy Statement or its implementation, here is how you can reach us:</p>
			        <p>In relation to the use of your personal data for the following purposes: support@isharelike.com</p>
			        <ul>
			            <li>providing, improving, and developing our products and services;</li>
			            <li>communicating with you;</li>
			            <li>sharing your personal data with third party partners for marketing communications;</li>
			        ...
			        <p>In relation to the use of your personal data for the provision of products and services you requested: data@shein.com</p>
			        <h3>COOKIE STATEMENT</h3>
			        <p>This Cookie Statement applies to all Love Share Co., Ltd. affiliates, brands, websites, products, and services (collectively, "iSHARE," "we," "us," or "our") and explains how we use cookies on our websites and online services and the choices you have.</p>
			        ...
			        <ul>
			            <li>Essential cookies: These cookies are strictly necessary to provide you with our websites and services and to enable essential features, such as providing shopping cart or live chart functionality. If you disable these cookies, we will not be able to fulfill your request.</li>
...
<style scoped>
	...
	.privacy p{padding:8px 0 ;color: #888;}
	.pricacy ul{margin-left: 3%;}
	.pricacy ul li{padding:6px 0;list-style: circle;}
</style>
